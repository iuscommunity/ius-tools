"""
This is the ExampleController for the iustools application.  This can be used
to expose commands to the example namespace which will be accessible under:

    $ iustools example --help
...
class ExampleController(CementController):
    ...
    def ex1(self):
        ...
        # So if you have added cli options in your iustools.bootstrap.example
    ...
    def ex1_help(self):
        ...
        executed when you run:
            ...
            $ iustools example ex1-help
        
        """
        print "This is the help method for ex1."
    
    @expose('iustools.templates.example.ex2', namespace='example')    
    def ex2(self): 
        """
    ...
    def cmd2(self):
        ...
        foo = "In iustools.controllers.example.cmd2()"
        print foo
        return dict(foo=foo)